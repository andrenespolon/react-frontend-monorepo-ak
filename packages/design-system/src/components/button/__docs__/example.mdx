import { Canvas, Meta, Primary, Story, Controls } from '@storybook/blocks';
import * as Button from './button.stories.tsx';
import * as Appearence from './appearence.stories.tsx';
import * as State from './state.stories.tsx';
import * as Icon from './icon.stories.tsx';
import * as Size from './size.stories.tsx';
import * as Component from './component.stories.tsx';
...
<Canvas of={Appearence.Primary} />

### Default

The default button theme.

<Canvas of={Appearence.Default} />
...
<Canvas of={Appearence.SubtleLink} />
...
<Canvas of={Icon.Before} />

### After

Display an icon after the text.

<Canvas of={Icon.After} />
...
<Canvas of={Size.Default} />

### Compact

<Canvas of={Size.Compact} />
